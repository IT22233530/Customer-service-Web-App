...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if($result == TRUE) {
            echo "&nbsp&nbsp&nbspResponded successfully";
        }else{
...
<html>
	...
	<nav>
        ...
        <h1 class="com">Responses</h1>

    <form method="post">
        <div>
            <label for="response" class="txts"> Enter your response:</label><br><br>
            <textarea id="response" name="response" rows="4" cols="50" placeholder="Enter your response details" style="margin-left: -220px;"></textarea>
        </div>
        <button class="submit" name="submit">Submit</button>
	</form>
	<button onclick="window.location.href='type.php'" class="home1">Return Home</button><br><br>
