...
<!DOCTYPE html>
	...
	<div class="animated-word">
		...
		<hr class="ruler">
	<br>
	<center><b><h1>Available Requests</h1></b></center>
	<table class="styled-table2" border="3">
  <thead>
    <tr>
		<th class="table-h">UserID</th>
      <th class="table-h">Name</th>
      <th class="table-h">E-mail</th>
	  <th class="table-h">Request</th>
	...
	<?php
		...
		if($result){
			while($row=mysqli_fetch_assoc($result)){
				...
				<td class="space">'. $request .'&nbsp&nbsp&nbsp&nbsp&nbsp</td>
                <td class="space"><button class="update"><a href="respond.php?updateid='.$id.'" class="update-a">RESPOND</a></button></td>
				<td class="space"><button class="delete"><a href="aRequestDelete.php?deleteid='.$id.'" class="delete-a">DELETE</a></button></td>
			  </tr>';
			}
		}
	?>
...
<button onclick="window.location.href='type.php';" class="returnadmin">Return to CSR Home</button><br><br>
