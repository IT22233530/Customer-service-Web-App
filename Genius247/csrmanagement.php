...
<!DOCTYPE html>
	...
	<button onclick="window.location.href='csrNew.php';" class="adduser">Add CSR User</button><br><br>
	<table class="styled-table" border="3">
  <thead>
    <tr>
		<th class="table-h">csrID</th>
	...
	<?php
		...
		if($result){
			while($row=mysqli_fetch_assoc($result)){
				...
				<td class="space">'. $lname .'&nbsp&nbsp&nbsp&nbsp&nbsp</td>
				<td class="space">'. $email .'&nbsp&nbsp&nbsp&nbsp&nbsp</td>
				<td class="space">'. $password .'&nbsp&nbsp&nbsp&nbsp&nbsp</td>
				<td class="space"><button class="update"><a href="csrupdate.php?updateid='.$id.'" class="update-a">UPDATE</a></button></td>
				<td class="space"><button class="delete"><a href="csrdelete.php?deleteid='.$id.'" class="delete-a">DELETE</a></button></td>
			  </tr>';
			}
		}
	?>
