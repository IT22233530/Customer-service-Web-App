...
<html>
	...
	<nav>
        <ul>
          <li><strong class="adminhome">Admin Home</strong></li>
        </ul>
      </nav><br><br>
	<center><button onclick="window.location.href='usermanagement.php';" class="user"><h1>User management</h1></button></center><br>
    <center><button onclick="window.location.href='csrmanagement.php';"class="user"><h1>Customer support management</h1></button></center><br>
    <center><button onclick="window.location.href='feedbackmanagement.php';"class="user"><h1>Feedback Management</h1></button></center><br>
	<center><button onclick="window.location.href='contacting.php';"class="user"><h1>Contacting Helps</h1></button></center>
	<br><br>
	<center><button onclick="window.location.href='index.html';"class="returnhome"><h1>Return to Genius 24/7 Home</h1></button></center>
	<br><br><footer class="footer-distributed">
