...
<html>
	...
	<nav>
        <ul>
          <li><strong class="adminhome" style="margin-left: 500px;">Availble Requests</strong></li>
        </ul>
      </nav><br><br>
	<center><button onclick="window.location.href='aRequest.php';" class="user"><h1>E-Commerce</h1></button></center><br>
    <center><button onclick="window.location.href='aRequest.php';"class="user"><h1>Financial</h1></button></center><br>
    <center><button onclick="window.location.href='aRequest.php';" class="user"><h1>Food & Beverage</h1></button></center><br>
    <center><button onclick="window.location.href='aRequest.php';" class="user"><h1>Health Care</h1></button></center><br>
    <center><button onclick="window.location.href='aRequest.php';" class="user"><h1>Information Technology</h1></button></center><br>
    <center><button onclick="window.location.href='aRequest.php';" class="user"><h1>Real Estate</h1></button></center><br>

	<br><br>
	<center><button onclick="window.location.href='index.html';"class="returnhome"><h1>Return to Genius 24/7 Home</h1></button></center>
	<br><br>
