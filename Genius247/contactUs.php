...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql="INSERT INTO `contactus`(`nname`, `email`, `problem`) VALUES ('$nname','$email','$problem')";
...
<html>
	...
	<nav>
        ...
        <h1 class="com">Contact US</h1>

    <form method="post">
		<div class="frm">
			<label for="name" class="txts">Name:</label><br><br>
			<input type="text" id="name" name="nname" placeholder="Enter Name" autocomplete="off"><br>
		</div>
		<div class="frm">
		...
		<br>
        <div>
            <label for="request" class="txts"> Enter your problem/request:</label><br><br>
            <textarea id="texts" name="problem" rows="4" cols="50" placeholder="Enter your problem/request details" style="margin-left: -220px;"></textarea>
        </div>
