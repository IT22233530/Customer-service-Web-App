...
<!DOCTYPE html>
	...
	<button onclick="window.location.href='signUp.php';" class="adduser">Add User</button><br><br>
	...
	<?php
		...
		if($result){
			while($row=mysqli_fetch_assoc($result)){
				...
				<td class="space"><button class="update"><a href="update.php?updateid='.$id.'" class="update-a">UPDATE</a></button></td>
				<td class="space"><button class="delete"><a href="delete.php?deleteid='.$id.'" class="delete-a">DELETE</a></button></td>
			  </tr>';
			}
		}
	?>
