...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql="UPDATE `signup` SET `UserID`='$id',`fname`='$fname',`lname`='$lname',`email`='$email',`password`='$password' WHERE UserID=$id";
...
<html>
	...
	<form method="post">
		<div class="frm">
			...
			<input type="text" id="fname" name="fname" placeholder="Enter First Name" autocomplete="off"><br>
		</div>
		<div class="frm">
			<label for="lname" class="txts">Last name:</label><br>
			<input type="text" id="lname" name="lname" placeholder="Enter Last Name" autocomplete="off">
	    </div>
		<div class="frm">
