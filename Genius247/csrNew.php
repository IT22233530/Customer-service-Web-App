...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql="INSERT INTO `csrnew`(`fname`, `lname`, `email`, `password`) VALUES ('$fname','$lname','$email','$password')";
...
<html>
	...
	<button onclick="window.location.href='admin.php'" class="home1">Return Admin Home</button><br><br>
